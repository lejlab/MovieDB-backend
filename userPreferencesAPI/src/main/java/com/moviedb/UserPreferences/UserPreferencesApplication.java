...
public class UserPreferencesApplication {
	...
	@Bean
	public CommandLineRunner demo(CommentsRepository commentsRepository, WatchlistsRepository watchlistsRepository, ReviewsBasicRepository reviewsBasicRepository){
		return (args) -> {
			...
			for (Review review : reviewsBasicRepository.findAll()) {
